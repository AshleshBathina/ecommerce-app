    ...
    <div className="bg-white min-h-screen">
      <div className="flex flex-col justify-center items-center min-h-screen md:flex-row">
        ...
        <div className="flex flex-col w-full px-6 gap-2 md:w-md">
          ...
          <p className="text-center px-6 mt-4 text-gray-400 font-inter font-medium text-[10px]">By signing up, you agree to our <a className="text-blue-500" href="https://www.google.com/policies/terms/
